...
def esegui_ricerca_geografica(origine_lat, origine_lon, zone, check_in, check_out, adulti, bambini, api_key, filtri_extra=None, max_risultati=10, eta_bambini=None):
    """
...
if check_password():
    ...
    if bambini > 0:
        ...
        cols_eta = st.sidebar.columns(min(int(bambini), 4) or 1)
