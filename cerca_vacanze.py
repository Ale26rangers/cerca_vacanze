...
if check_password():
    ...
    if usa_ricerca_geografica:
        ...
        max_hotel_per_zona = st.sidebar.slider(
            ...
            help="Quanti risultati (ordinati per rilevanza da Google) prendere da ciascuna zona. "
                 "Un numero più alto copre meglio la zona ma la risposta di Google Hotels è un po' "
                 "più pesante da scaricare; non consuma comunque più di 1 ricerca per zona."
        )
