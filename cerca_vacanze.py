...
if check_password():
    ...
    if usa_ricerca_geografica:
        ...
        st.sidebar.markdown("**🏡 B&B e case vacanza**")
        cerca_bnb = st.sidebar.checkbox(
        ...
        if cerca_bnb:
            ...
            col_camere, col_bagni = st.sidebar.columns(2)
            with col_camere:
            ...
            st.sidebar.caption("↑ Solo per B&B/case vacanza (0 = nessun limite). Non si applica agli hotel.")
