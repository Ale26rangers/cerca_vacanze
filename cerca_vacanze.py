...
def to_excel(df):
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
        ...
        # Corpo tabella: valori + altezza riga calcolata sul testo più lungo tra le colonne "testo"
        for row_idx, (_, row) in enumerate(df.iterrows(), start=1):
            ...
            for col_idx, (chiave, intestazione, tipo, w_min, w_max) in enumerate(colonne_presenti):
                ...
                if tipo == "testo" and larghezze[col_idx] > 0 and valore:
